...
import marketingCampaignsRoutes from './routes/marketing-campaigns.js';
import profilesRoutes from './routes/profiles.js';
import rolesRoutes from './routes/roles.js';
import userRolesRoutes from './routes/user-roles.js';
import billingPlansRoutes from './routes/billing-plans.js';
import contactFormSubmissionsRoutes from './routes/contact-form-submissions.js';
import contactSubmissionsRoutes from './routes/contact-submissions.js';
...
app.use('/api/contact-form-submissions', contactFormSubmissionsRoutes);
